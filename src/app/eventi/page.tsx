  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-12">
      <main className="container mx-auto px-4">
        ...
        <div className="mb-20">
            <h2 className="text-3xl font-bold tracking-tight text-center mb-8">Calendario Eventi</h2>
            <EventCalendar events={eventiItems} />
        </div>

        <div>
            <h2 className="text-3xl font-bold tracking-tight text-center mb-8">Prossimi Eventi in Dettaglio</h2>
